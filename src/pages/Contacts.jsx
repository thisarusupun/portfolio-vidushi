...
<a href="mailto:ebbandara199@gmail.com" className='text-white poppins-thin text-[16px] w-[30vw]'>
...
<div className='flex flex-row space-x-[0.75vw] pt-[25px] pb-[27px] w-[30vw]'>
...
<div className='relative top-[680px] md:top-[390px] left-[10.175vw] md:w-[7.45vw] h-[59.83px] bg-transparent'>
  ...
  <path className="hover:scale-95 duration-200" id="Icon_awesome-facebook" data-name="Icon awesome-facebook" d="M18.5,9.534A8.971,8.971,0,1,0,8.132,18.4V12.127H5.853V9.534H8.132V7.557a3.165,3.165,0,0,1,3.388-3.49,13.806,13.806,0,0,1,2.008.175V6.449H12.4a1.3,1.3,0,0,0-1.462,1.4V9.534h2.488l-.4,2.593h-2.09V18.4A8.974,8.974,0,0,0,18.5,9.534Z" transform="translate(-0.563 -0.563)" fill="#fff"/>
</svg>
</a>
<a href="https://www.instagram.com/invites/contact/?i=fuw748pwvrrn&utm_content=u6x36mv" target="_blank">
<svg xmlns="http://www.w3.org/2000/svg" width="17.335" height="17.335" viewBox="0 0 17.335 17.335">
  <g className="hover:scale-95 duration-200" id="Icon_ionic-logo-instagram" data-name="Icon ionic-logo-instagram" transform="translate(-4.5 -4.5)">
...
<a href="https://www.linkedin.com/in/udeshi-bandara-29a394203/?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank">
<svg xmlns="http://www.w3.org/2000/svg" width="16.813" height="16.813" viewBox="0 0 16.813 16.813">
  <path className="hover:scale-95 duration-200" id="Icon_awesome-linkedin" data-name="Icon awesome-linkedin" d="M15.612,2.25H1.2A1.206,1.206,0,0,0,0,3.462V17.851a1.206,1.206,0,0,0,1.2,1.212H15.612a1.209,1.209,0,0,0,1.2-1.212V3.462A1.209,1.209,0,0,0,15.612,2.25ZM5.081,16.661H2.59V8.638h2.5v8.024ZM3.836,7.542A1.445,1.445,0,1,1,5.28,6.1,1.446,1.446,0,0,1,3.836,7.542Zm10.587,9.12H11.931v-3.9c0-.931-.019-2.128-1.295-2.128-1.3,0-1.5,1.013-1.5,2.06v3.971H6.646V8.638H9.037v1.1h.034a2.625,2.625,0,0,1,2.361-1.295c2.522,0,2.991,1.663,2.991,3.824Z" transform="translate(0 -2.25)" fill="#fff"/>
</svg>
</a>
</div>
</div>
