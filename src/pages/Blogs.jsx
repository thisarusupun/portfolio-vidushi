      ...
      <div className="bg-[url('src/Assests/images/blog.png')] h-[1425px] md:h-[782px]">
        ...
        <div className="h-[71px] pt-[10px]">
          ...
          <div className='flex flex-col md:flex-row pt-[80px] space-y-5 md:space-y-0 md:space-x-[1.171vw] justify-center'>
            <div className='relative h-[358px] w-full md:w-[25.76vw] bg-black border border-white opacity-100 backdrop-blur-sm'>
              <img src="src\Assests\images\blog1.png" alt="blog 01 image" className="w-full h-[250px] object-cover"/>
            ...
            <div className='relative h-[358px] w-full md:w-[25.76vw] bg-black border border-white opacity-100 backdrop-blur-sm mx-auto'>
              <img src="src\Assests\images\blog2.png" alt="blog 02 image" className="w-full h-[250px] object-cover"/>
            ...
            <div className='relative h-[358px] w-full md:w-[25.76vw] bg-black border border-white opacity-100 backdrop-blur-sm mx-auto'>
              <img src="src\Assests\images\blog3.png" alt="blog 03 image" className="w-full h-[250px] object-cover"/>
